        ...
        {!data.error && (
          <div className="d365-options-toolbar">
            ...
            <div className="d365-options-search" style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
              {shadowCount > 0 && (
                <label
                  title="Dataverse auto-creates read-only String shadow attributes for every custom lookup — e.g. rg_username and rg_useryominame for the rg_user lookup. They mirror the related record's primary-name value and can't be set directly. Tick to hide them; untick to show all attributes."
                  style={{
                    display: 'flex',
                    alignItems: 'center',
                    gap: 6,
                ...
                >
                  ...
                  />
                  Hide auto-generated lookup fields
                  <span
                    aria-hidden="true"
                    style={{
                      marginLeft: 2,
